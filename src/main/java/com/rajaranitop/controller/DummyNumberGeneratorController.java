...
import com.rajaranitop.service.DummyNumberGeneratorService;
...
@CrossOrigin
public class DummyNumberGeneratorController {

    @Autowired
    private DummyNumberGeneratorService numberGeneratorService;
    ...
    public ResponseEntity<Object> showResultTable(@RequestParam("date")
        ...
        List<DummyLuckyNumberTable> resultList = numberGeneratorService.getResultsForDate(date);
